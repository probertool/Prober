...
@.str.1 = private unnamed_addr constant [18 x i8] c"an error occurred\00", align 1
...
define dso_local i32 @main() #0 !dbg !10 {
  ...
  call void (i32, i32, i8*, i32, i8*, ...) @error_at_line(i32 0, i32 0, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i32 0, i32 0)), !dbg !14
  ret i32 0, !dbg !15
}
...
!10 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 48, type: !11, scopeLine: 49, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!11 = !DISubroutineType(types: !12)
!12 = !{!13}
!13 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!14 = !DILocation(line: 50, column: 1, scope: !10)
!15 = !DILocation(line: 52, column: 3, scope: !10)
