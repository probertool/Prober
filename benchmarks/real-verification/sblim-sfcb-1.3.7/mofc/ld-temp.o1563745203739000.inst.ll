...
define dso_local i32 @main() #0 !dbg !10 {
  ...
  %2 = call noalias i8* @malloc(i64 0) #2, !dbg !14
  %3 = icmp ne i8* %2, null, !dbg !15
  %4 = xor i1 %3, true, !dbg !15
  %5 = zext i1 %4 to i32, !dbg !15
  ret i32 %5, !dbg !16
}
...
!10 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 36, type: !11, scopeLine: 37, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!11 = !DISubroutineType(types: !12)
!12 = !{!13}
!13 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!14 = !DILocation(line: 38, column: 10, scope: !10)
!15 = !DILocation(line: 38, column: 8, scope: !10)
!16 = !DILocation(line: 38, column: 1, scope: !10)
