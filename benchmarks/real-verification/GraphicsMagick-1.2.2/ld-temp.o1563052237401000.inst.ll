...
define dso_local i32 @main() #0 !dbg !9 {
  ...
  %2 = call signext i8 (...) @argz_create_sep(), !dbg !13
  %3 = sext i8 %2 to i32, !dbg !13
  ret i32 %3, !dbg !14
}

declare dso_local signext i8 @argz_create_sep(...) #1
...
!9 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 65, type: !10, scopeLine: 66, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!10 = !DISubroutineType(types: !11)
!11 = !{!12}
!12 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!13 = !DILocation(line: 67, column: 8, scope: !9)
!14 = !DILocation(line: 67, column: 1, scope: !9)
