...
define dso_local void @cl_symbol1() #0 !dbg !9 {
  ret void, !dbg !12
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cli_symbol2() #0 !dbg !13 {
  ret void, !dbg !14
}
...
!9 = distinct !DISubprogram(name: "cl_symbol1", scope: !1, file: !1, line: 1, type: !10, scopeLine: 1, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!10 = !DISubroutineType(types: !11)
!11 = !{null}
!12 = !DILocation(line: 1, column: 24, scope: !9)
!13 = distinct !DISubprogram(name: "cli_symbol2", scope: !1, file: !1, line: 2, type: !10, scopeLine: 2, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!14 = !DILocation(line: 2, column: 25, scope: !13)
