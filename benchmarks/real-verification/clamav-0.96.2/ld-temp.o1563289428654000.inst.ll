...
@.str.3 = private unnamed_addr constant [15 x i8] c"fprintf failed\00", align 1
...
define dso_local i32 @main() #0 !dbg !9 {
  ...
  %3 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0)), !dbg !77
  store %struct._IO_FILE* %3, %struct._IO_FILE** %2, align 8, !dbg !76
  %4 = load %struct._IO_FILE*, %struct._IO_FILE** %2, align 8, !dbg !78
  %5 = icmp ne %struct._IO_FILE* %4, null, !dbg !78
  br i1 %5, label %6, label %14, !dbg !80

; <label>:6:                                      ; preds = %0
  %7 = load %struct._IO_FILE*, %struct._IO_FILE** %2, align 8, !dbg !81
  %8 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %7, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i32 1024), !dbg !84
  %9 = icmp slt i32 %8, 1, !dbg !85
  br i1 %9, label %10, label %13, !dbg !86

; <label>:10:                                     ; preds = %6
  call void @perror(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0)), !dbg !87
  %11 = call i32* @__errno_location() #4, !dbg !89
  %12 = load i32, i32* %11, align 4, !dbg !89
  store i32 %12, i32* %1, align 4, !dbg !90
  br label %18, !dbg !90
...
; <label>:14:                                     ; preds = %0
  call void @perror(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.4, i32 0, i32 0)), !dbg !92
  %15 = call i32* @__errno_location() #4, !dbg !94
  %16 = load i32, i32* %15, align 4, !dbg !94
  store i32 %16, i32* %1, align 4, !dbg !95
  br label %18, !dbg !95
...
; <label>:18:                                     ; preds = %17, %14, %10
  %19 = load i32, i32* %1, align 4, !dbg !97
  ret i32 %19, !dbg !97
}
...
!9 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 135, type: !10, scopeLine: 135, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!10 = !DISubroutineType(types: !11)
!11 = !{!12}
!12 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!13 = !DILocalVariable(name: "fp", scope: !9, file: !1, line: 136, type: !14)
...
!76 = !DILocation(line: 136, column: 15, scope: !9)
!77 = !DILocation(line: 136, column: 20, scope: !9)
!78 = !DILocation(line: 137, column: 5, scope: !79)
!79 = distinct !DILexicalBlock(scope: !9, file: !1, line: 137, column: 5)
!80 = !DILocation(line: 137, column: 5, scope: !9)
!81 = !DILocation(line: 138, column: 15, scope: !82)
!82 = distinct !DILexicalBlock(scope: !83, file: !1, line: 138, column: 6)
!83 = distinct !DILexicalBlock(scope: !79, file: !1, line: 137, column: 9)
!84 = !DILocation(line: 138, column: 6, scope: !82)
!85 = !DILocation(line: 138, column: 39, scope: !82)
!86 = !DILocation(line: 138, column: 6, scope: !83)
!87 = !DILocation(line: 139, column: 4, scope: !88)
!88 = distinct !DILexicalBlock(scope: !82, file: !1, line: 138, column: 45)
!89 = !DILocation(line: 140, column: 11, scope: !88)
!90 = !DILocation(line: 140, column: 4, scope: !88)
!91 = !DILocation(line: 142, column: 2, scope: !83)
!92 = !DILocation(line: 143, column: 3, scope: !93)
!93 = distinct !DILexicalBlock(scope: !79, file: !1, line: 142, column: 9)
!94 = !DILocation(line: 144, column: 10, scope: !93)
!95 = !DILocation(line: 144, column: 3, scope: !93)
!96 = !DILocation(line: 146, column: 9, scope: !9)
!97 = !DILocation(line: 147, column: 1, scope: !9)
