...
define dso_local i32 @main() #0 !dbg !228 {
  ...
  call void @llvm.dbg.declare(metadata i32* %2, metadata !233, metadata !DIExpression()), !dbg !234
  %3 = call i64 @sysconf(i32 30) #3, !dbg !235
  %4 = trunc i64 %3 to i32, !dbg !235
  store i32 %4, i32* %2, align 4, !dbg !234
  ret i32 0, !dbg !236
}
...
!222 = !{!"clang version 8.0.1 (https://github.com/llvm-mirror/clang.git 2e4c9c5fc864c2c432e4c262a67c42d824b265c6) (https://github.com/rqtian/llvm80-bufferoverflow.git 38b4a62b0634ac2bc4b67addab5698d2f1a5c23e)"}
!223 = !{i32 2, !"Dwarf Version", i32 4}
!224 = !{i32 2, !"Debug Info Version", i32 3}
!225 = !{i32 1, !"wchar_size", i32 4}
!226 = !{i32 1, !"ThinLTO", i32 0}
!227 = !{i32 1, !"EnableSplitLTOUnit", i32 0}
!228 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 101, type: !229, scopeLine: 102, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !232)
!229 = !DISubroutineType(types: !230)
!230 = !{!231}
!231 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!232 = !{}
!233 = !DILocalVariable(name: "x", scope: !228, file: !1, line: 103, type: !231)
!234 = !DILocation(line: 103, column: 5, scope: !228)
!235 = !DILocation(line: 103, column: 9, scope: !228)
!236 = !DILocation(line: 105, column: 3, scope: !228)
