...
define dso_local i32 @main() #0 !dbg !11 {
  ...
  ret i32 ptrtoint (i32 (i8*, i8*, i8*, i8*, i32)* @__dn_expand to i32), !dbg !15
}

; Function Attrs: nounwind
declare dso_local i32 @__dn_expand(i8*, i8*, i8*, i8*, i32) #1
...
!11 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 108, type: !12, scopeLine: 108, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!12 = !DISubroutineType(types: !13)
!13 = !{!14}
!14 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!15 = !DILocation(line: 108, column: 14, scope: !11)
