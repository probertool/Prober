...
The generic syntax is:
	...
	ffmpeg [global options] [[infile options][B<-i> <infile>]]... {[outfile options] <outfile>}...
...
FFmpeg C<b> option is expressed in bits/s, lame C<bitrate>
in kilobits/s.
...
(b) Set bitrate in bits/s. Note that FFmpeg C<b> option is
expressed in bits/s, twolame C<b> in kilobits/s. The default
value is 128k.
