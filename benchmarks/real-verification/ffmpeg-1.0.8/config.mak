...
CC_IDENT=gcc 6.3.0 (Debian 6.3.0-18+deb9u1) 20170516
ARCH=x86
CC=gcc
CXX=g++
AS=gcc
...
LD_PATH=-L
DLLTOOL=
LDFLAGS=-rdynamic /root/llvm/Prober/libprober.so  -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
