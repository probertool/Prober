...
; <label>:34:                                     ; preds = %30
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !165
  %36 = call i8* @MagickMalloc(i64 %35), !dbg !165
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !165
...
; <label>:42:                                     ; preds = %12
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !171
  %49 = call i8* @MagickRealloc(i8* %47, i64 %48), !dbg !171
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !171
...
!88 = !{!6, !70}
!89 = !{!"clang version 8.0.1 (https://github.com/llvm-mirror/clang.git 2e4c9c5fc864c2c432e4c262a67c42d824b265c6) (https://github.com/rqtian/llvm80-bufferoverflow.git 3b5df6d2abd65c292843e89e82bd69d3349a41e2)"}
