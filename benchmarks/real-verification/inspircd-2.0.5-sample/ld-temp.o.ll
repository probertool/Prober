...
define dso_local i32 @main() #0 !dbg !71 {
  ...
  %3 = call i8* @_Znam(i64 512) #3, !dbg !79
...
!1 = !DIFile(filename: "main.c", directory: "/root/llvm/codesample/39apps/inspircd-2.0.5-sample")
!2 = !{}
!3 = !{!4, !61}
...
!71 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 4, type: !72, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!72 = !DISubroutineType(types: !73)
!73 = !{!74}
!74 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!75 = !DILocalVariable(name: "res", scope: !71, file: !1, line: 5, type: !76)
!76 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !77, size: 64)
!77 = !DIBasicType(name: "unsigned char", size: 8, encoding: DW_ATE_unsigned_char)
!78 = !DILocation(line: 5, column: 21, scope: !71)
!79 = !DILocation(line: 6, column: 8, scope: !71)
!80 = !DILocation(line: 6, column: 6, scope: !71)
!81 = !DILocation(line: 8, column: 2, scope: !71)
