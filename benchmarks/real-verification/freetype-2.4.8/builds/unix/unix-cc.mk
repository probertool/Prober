...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -flto -fPIC -g -v -DFT_CONFIG_OPTION_SYSTEM_ZLIB -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# export symbols
#
CCraw_build  := /root/llvm/llvm80/build/bin/clang	# native CC of building system
