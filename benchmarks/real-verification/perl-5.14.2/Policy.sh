...
case "$perladmin" in
'') perladmin='root@3e7fa76cc3dc.(none)' ;;
esac
...
case "$siteprefix" in
'') if test "$PWD/build" = "$PWD/build"; then
	siteprefix="$prefix"
    else
	siteprefix='$PWD/build'
    fi
    ;;
esac
case "$vendorprefix" in
'') if test "" = "$PWD/build"; then
	vendorprefix="$prefix"
    else
	vendorprefix=''
    fi
...
#     $PWD/build, so it isn't included here either.
#
...
bin='/root/llvm/codesample/39apps/perl-5.14.2/UU/build/bin'
# scriptdir='/root/llvm/codesample/39apps/perl-5.14.2/UU/build/bin'
# Preserving custom privlib
privlib='/root/llvm/codesample/39apps/perl-5.14.2/UU/build/lib/perl5/5.14.2'
# archlib='/root/llvm/codesample/39apps/perl-5.14.2/UU/build/lib/perl5/5.14.2/x86_64-linux'
# man1dir='$PWD/build/man/man1'
# man3dir='$PWD/build/man/man3'
# man1ext='1'
# man3ext='3'
...
html3dir=' '
# sitebin='$PWD/build/bin'
# sitescript='$PWD/build/bin'
# sitelib='$PWD/build/lib/perl5/site_perl/5.14.2'
# sitearch='$PWD/build/lib/perl5/site_perl/5.14.2/x86_64-linux'
# siteman1dir='$PWD/build/man/man1'
# siteman3dir='$PWD/build/man/man3'
# sitehtml1dir=''
# sitehtml3dir=''
# vendorbin=''
# vendorscript=''
