...
define dso_local i32 @main() #0 !dbg !9 {
  ...
  call void @llvm.dbg.declare(metadata i8** %2, metadata !13, metadata !DIExpression()), !dbg !20
  br label %3, !dbg !21

; <label>:3:                                      ; preds = %0
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !22
  %4 = call noalias i8* @calloc(i64 70, i64 1) #3, !dbg !22
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !22
...
!1 = !DIFile(filename: "main.c", directory: "/root/llvm/codesample/39apps/ettercap-0.8.1-sample")
!2 = !{}
...
!13 = !DILocalVariable(name: "response", scope: !9, file: !1, line: 27, type: !14)
!14 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !15, size: 64)
!15 = !DIDerivedType(tag: DW_TAG_typedef, name: "u_char", file: !16, line: 33, baseType: !17)
!16 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/sys/types.h", directory: "")
!17 = !DIDerivedType(tag: DW_TAG_typedef, name: "__u_char", file: !18, line: 30, baseType: !19)
!18 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/types.h", directory: "")
!19 = !DIBasicType(name: "unsigned char", size: 8, encoding: DW_ATE_unsigned_char)
!20 = !DILocation(line: 27, column: 13, scope: !9)
!21 = !DILocation(line: 28, column: 2, scope: !9)
!22 = !DILocation(line: 28, column: 2, scope: !23)
!23 = distinct !DILexicalBlock(scope: !9, file: !1, line: 28, column: 2)
!24 = !DILocation(line: 30, column: 2, scope: !9)
