...
define internal i32 @alloc_list(%struct.string_list_s*) #0 !dbg !577 {
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !588
  %9 = call noalias i8* @calloc(i64 %8, i64 16) #8, !dbg !588
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !589
...
define internal %struct.string_item_s* @read_file(%struct.config_s*, i8*) #0 !dbg !1245 {
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !1261
  %21 = call noalias i8* @malloc(i64 %20) #8, !dbg !1261
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !1253
...
define internal %struct.string_item_s* @add_item(%struct.string_list_s*, i8*, i32) #0 !dbg !1737 {
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !1751
  %13 = call noalias i8* @malloc(i64 %12) #8, !dbg !1751
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !1747
...
; <label>:34:                                     ; preds = %31, %22
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !1786
  %50 = call i8* @mrealloc(i8* %38, i64 %44, i64 %49) #9, !dbg !1786
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !1787
...
!101 = !{!"clang version 8.0.1 (https://github.com/llvm-mirror/clang.git 2e4c9c5fc864c2c432e4c262a67c42d824b265c6) (https://github.com/rqtian/llvm80-bufferoverflow.git c257efa2d375141bf09ac0e6170370eae4521829)"}
