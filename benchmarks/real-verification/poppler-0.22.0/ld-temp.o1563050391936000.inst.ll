...
define dso_local i32 @main() #0 !dbg !10 {
  ...
  call void (...) @jpeg_CreateDecompress(), !dbg !14
  ret i32 0, !dbg !15
}

declare void @jpeg_CreateDecompress(...) #1
...
!10 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 49, type: !11, scopeLine: 50, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!11 = !DISubroutineType(types: !12)
!12 = !{!13}
!13 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!14 = !DILocation(line: 51, column: 1, scope: !10)
!15 = !DILocation(line: 53, column: 3, scope: !10)
