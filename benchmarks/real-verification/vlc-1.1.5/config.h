...
#define CONFIGURE_LINE "./configure  '--disable-qt4' '--disable-skins2' '--prefix=/root/llvm/codesample/39apps/vlc-1.1.5/build' 'CC=/root/llvm/llvm80/build/bin/clang -flto' 'CFLAGS=-flto -fPIC -g -v' 'LDFLAGS=/root/llvm/Prober/libprober.so' 'CXX=/root/llvm/llvm80/build/bin/clang++ -flto' 'CXXFLAGS=-flto -fPIC -g -v'"
...
#define VLC_COMPILE_HOST "3e7fa76cc3dc"
