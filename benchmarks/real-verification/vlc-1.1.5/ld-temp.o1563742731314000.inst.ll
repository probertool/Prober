...
define dso_local i32 @main() #0 !dbg !10 {
  ...
  %2 = call signext i8 (...) @fork(), !dbg !14
  %3 = sext i8 %2 to i32, !dbg !14
  ret i32 %3, !dbg !15
}

declare signext i8 @fork(...) #1
...
!10 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 73, type: !11, scopeLine: 74, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!11 = !DISubroutineType(types: !12)
!12 = !{!13}
!13 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!14 = !DILocation(line: 75, column: 8, scope: !10)
!15 = !DILocation(line: 75, column: 1, scope: !10)
