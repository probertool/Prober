...
define dso_local i32 @main() #0 !dbg !10 {
  ...
  %2 = call signext i8 (...) @posix_madvise(), !dbg !14
  %3 = sext i8 %2 to i32, !dbg !14
  ret i32 %3, !dbg !15
}

declare signext i8 @posix_madvise(...) #1
...
!14 = !DILocation(line: 84, column: 8, scope: !10)
!15 = !DILocation(line: 84, column: 1, scope: !10)
