...
; <label>:127:                                    ; preds = %124, %116
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !1135
  %131 = call noalias i8* @malloc(i64 104) #10, !dbg !1135
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !1136
...
define internal noalias %struct.rtp_session_t* @rtp_session_create(%struct.demux_t* nocapture readnone) #0 !dbg !2685 {
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !2997
  %2 = tail call noalias i8* @malloc(i64 24) #10, !dbg !2997
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !2998
...
; <label>:137:                                    ; preds = %129
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !3371
  %143 = tail call i8* @realloc(i8* %139, i64 %142) #10, !dbg !3371
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !3371
