...
; <label>:14:                                     ; preds = %10
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !789
  %15 = call noalias i8* @calloc(i64 1, i64 48) #10, !dbg !789
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !790
...
; <label>:19:                                     ; preds = %14
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !806
  %26 = call noalias i8* @calloc(i64 1, i64 64) #10, !dbg !806
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !807
...
; <label>:97:                                     ; preds = %83
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !1337
  %98 = call noalias i8* @calloc(i64 1, i64 32) #10, !dbg !1337
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !1338
...
; <label>:155:                                    ; preds = %153, %143
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !1425
  %157 = call noalias i8* @calloc(i64 1, i64 16) #10, !dbg !1425
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !1425
...
; <label>:10:                                     ; preds = %2
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !1625
  %19 = call i8* @realloc(i8* %11, i64 %18) #10, !dbg !1625
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !1626
...
; <label>:31:                                     ; preds = %27, %13
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !1692
  %33 = tail call noalias i8* @calloc(i64 1, i64 32) #10, !dbg !1692
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !1693
...
; <label>:10:                                     ; preds = %1
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !1848
  %11 = tail call noalias i8* @calloc(i64 1, i64 24) #10, !dbg !1848
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !1849
...
; <label>:32:                                     ; preds = %30, %23
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !1881
  %33 = tail call noalias i8* @calloc(i64 1, i64 64) #10, !dbg !1881
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !1882
...
; <label>:38:                                     ; preds = %36, %24
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !2657
  %39 = call noalias i8* @malloc(i64 1028) #10, !dbg !2657
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !2658
...
; <label>:50:                                     ; preds = %44
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !3821
  %51 = call noalias i8* @malloc(i64 16384) #10, !dbg !3821
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !3822
