...
151:                                              ; preds = %146, %115
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !475
  %156 = call noalias i8* @malloc(i64 %155) #7, !dbg !475
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !476
...
35:                                               ; preds = %25
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !605
  %47 = call i8* @realloc(i8* %43, i64 %46) #7, !dbg !605
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !606
...
166:                                              ; preds = %161
  ...
  store volatile i8 1, i8* @specialMalloc, align 1, !dbg !830
  %169 = call noalias i8* @malloc(i64 %168) #7, !dbg !830
  store volatile i8 0, i8* @specialMalloc, align 1, !dbg !831
